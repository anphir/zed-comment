...
image::screenshot-single-line.png[,50%]

.Zed highlighting multi-line comments.
image::screenshot-multi-line.png[,60%]
...
The surrounding brackets and the trailing colon use default punctuation highlighting.

The styles need to be added to Zed's `settings.json`, otherwise the default comment style will be applied.
