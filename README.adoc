⚠️ Pull request https://github.com/zed-industries/extensions/pull/2865[#2865] attempting to add this to Zed extensions was closed in favour of https://github.com/zed-industries/extensions/pull/3393[#3393].
This repository has become obsolete and will probably be removed in the near future. ⚠️
